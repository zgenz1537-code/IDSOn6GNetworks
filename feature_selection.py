...
from ISSOA import ImprovedSparrowSearchOptimizer
...
def select_features(df):
    ...
    print("[INFO] Feature Selection Using Improved Sparrow Search Optimizer Algorithm")
    solution = ImprovedSparrowSearchOptimizer(
        num_agents=1,
        max_iter=25,
        train_data=x_,
        train_label=y_,
